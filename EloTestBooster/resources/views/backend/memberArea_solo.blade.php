			...
			<div class="row">
						...
						<div class="order-information">
							<div class="order-inspect d-flex">
								<div class="single-inspect">
									<span>Order&nbspId</span>
									<strong>{{ $order_id->id }}</strong>
								</div>
								<div class="single-inspect">
									<span>Order&nbspStatus</span>
									<strong>In&nbspHold</strong>
								</div>
								<!-- <div class="single-inspect">
									<span>User Name</span>
									<strong></strong>
							...
							<div class="order-status mt-3 d-flex">
								...
								<div class="order-status-information">
									<h5>Order&nbspIn&nbspProgress</h5>
				...
				<div class="col-sm-12">
					<form method="POST" action="{{route('solo_account')}}">
						...
						<input type="hidden"  name="order_id" value="{{$order_id}}" required autofocus>
						<div class="order-form form-row mt-5">
							<div class="form-group col-md-6 col-lg-3 col-sm-12">
								<label for="accountName">Account&nbspName</label>
							...
							<div class="form-group col-md-6 col-lg-3 col-sm-12">
								<label for="suommerName">Summoner&nbspName</label>
				...
				<div class="col-sm-12 mt-5">
					<div class="row pt-5 pb-5">
						...
						<div class="col-md-3 d-flex flex-column mt-auto">
							<button class="btn btn-primary"  data-toggle="modal" data-target="#giftModal" style="margin-top:20px;background-color:#a67c33!important;border-color:#a67c33!important">Gift Booster</button>
