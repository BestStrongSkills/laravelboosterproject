	...
	<div class="container main-container">
								...
								<div class="flex-container" style="display: flex;flex-direction: column;padding-top:20px;padding-bottom:20px"> 
		                    		...
		                    		<div style="text-align:left;line-height:20px;font-size: 16px;padding:10px;">
			                    		<span>Task</span><span style="text-align:right;margin-left:20px">
											...
											<span style="margin-left:10px;font-size:12px;">{{$description->totalData}}</span>
		                    		</div>
		            ...
		            <div class="col-sm-12 mt-5" >
						<div class="flex-container" style="display: flex;flex-direction: column;">
							<div class="panel panel-default" style="background-color:#636363;line-height: 150px;">
			                    ...
			                    <div class="panel-body">
			                    	<div class="flex-container" style="display: flex;flex-direction: column;"> 
			                    		<div style=" text-align: center;line-height:35px;font-size: 20px;">
										...
										<div class="ranks row">
											<div class="starting-rank col-lg-3 col-sm-4 col-xs-4">
												@if(!empty($startingRanks))
													...
													<p class="text-center">
														<h5 style="padding-left:37px">Starting Rank</h5>
														<em style="padding-left:37px;text-align:center !important">{{ $startingRanks->member_starting_rank }}</em>
							...
							<div class="row pt-5 pb-5">
								<div class="chatbox col-sm-12 col-md-12">
									<div class="chatbox-container d-block">
										<div class="chatbox-inner" style="max-height: 570px;">
											<div class="chats">
		...
		<div class="row">
		    <div class="col-lg-12">
		        <div class="card-box">
		            <div>
		                <button type="button" class="btn btn-primary waves-effect waves-light col-md-1" style="margin:5px;;background-color:#ed1c24;border-color:#ed1c24!important">Pause</button>

		                <button type="button" class="btn btn-primary waves-effect col-md-2" style="background-color:#006600;margin:5px;">UnPause</button>

		                <button type="button" class="btn btn-primary waves-effect waves-light col-md-1" style="margin:5px;background-color:#ed1c24!important;border-color:#ed1c24!important">Close</button>

		                <!-- <button type="button" class="btn btn-info waves-effect waves-light col-md-2">Info</button> -->

		                <button type="button" class="btn btn-primary waves-effect waves-light col-md-1" style="color:white;margin:5px;background-color:#006600!important;border-color:#006600!important">Publish</button>

		                <button type="button" class="btn btn-primary waves-effect waves-light col-md-1" style="margin:5px;background-color:#ed1c24;border-color:#ed1c24!important">Re-assign</button>

		                <button type="button" class="btn btn-primary waves-effect waves-light col-md-2" style="background-color:#006600!important;margin:5px;">Assign</button>

		                <button type="button" class="btn btn-primary waves-effect col-md-2" style="margin:5px;background-color:#999999">Type Booster</button>

		                <!-- <button type="button" class="btn btn-link waves-effect offset-3">Link</button> -->
		            </div>
		        </div>
		    </div>
		</div>
	                    ...
	                    <table class="table table-bordered dataTable no-footer table match-history" id="datatable" class="" role="grid" aria-describedby="datatable_info" style="background-color:#636363;border:0!important;">
	                        ...
	                        <tr>
	                            ...
	                            <td style="border:0px !important">
	                                ...
	                                <img src="{{asset('images/items/22.png')}}" class="img-responsive" alt="" style="width:38px;height:30px;margin:0 auto;margin-top:10px"/>
	                                <img src="{{asset('images/items/23.png')}}" class="img-responsive" alt="" style="width:38px;height:30px;margin:0 auto;margin-top:10px"/>
	                                <img src="{{asset('images/items/24.png')}}" class="img-responsive" alt="" style="width:38px;height:30px;margin:0 auto;margin-top:10px"/>
	                                </td>
	                            <td style="border:0px !important">
