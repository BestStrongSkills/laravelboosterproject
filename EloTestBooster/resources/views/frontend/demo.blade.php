...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/backend/memberArea_solo.css">
	<link rel="stylesheet" href="secondFonts/big-stylesheet.css">
    <link rel="stylesheet" href="css/font-awesome.css">
    <script defer src="js/backend/all.js"></script>
...
<body>
	<header>
		<div class="container">
			<div id="mySidenav" class="sidenav">
			  	...
			  	<a class="nav-link white-menu" href="" >MEMBER AREA SOLO</a></li>
		        <a class="nav-link white-menu" href="" >MEMBER AREA DUO</a></li>
		        <a class="nav-link white-menu" href="#">MEMBER AREA PROFILE</a>
		        <a class="nav-link white-menu" href="" >REVIEW BOOSTER</a>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="logo-container text-center">
					<a href="#">
						<img src="images/EloBoosting/logo.png" width="100" />
					</a>
				</div>
			</div>
			...
			<div class="col-sm-12">
				<div class="order-details d-flex mt-5">
					<div class="order-image mr-5">
						<img src="images/MemberArea/poro.png">
					</div>
			...
			<div class="col-sm-12">
				<div class="order-form form-row mt-5">
					<div class="form-group col-md-6 col-lg-3 col-sm-12">
						...
						<input type="text" name="accountName" id="accountName" class="theme-form form-control">
					</div>
					<div class="form-group col-md-6 col-lg-3 col-sm-12">
						<label for="password">Password</label>
						<input type="password" name="password" id="password" class="theme-form form-control">
					</div>
					<div class="form-group col-md-6 col-lg-3 col-sm-12">
						<label for="suommerName">Summoner Name</label>
						<input type="text" name="suommerName" id="suommerName" class="theme-form form-control">
					</div>
					<div class="form-group col-md-6 col-lg-3 col-sm-12">
						<label for="server">Server Name</label>
						<input type="text" name="server" id="server" class="theme-form form-control">
					</div>
					...
					<div class="col-md-6 col-lg-5 mt-3 champions-picker">
						...
						<ul class="champions">
							<li>
								<img src="images/champions/Darius.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/champions/Janna.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/champions/Khazix.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/champions/Swain.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/champions/Xayah.png" class="rounded-circle">
							</li>
					...
					<div class="col-md-6 col-lg-5 mt-3 roles-picker">
						...
						<ul class="roles">
							<li>
								<img src="images/roles/top.png" class="rounded-circle">
							</li>
							<li class='active'>
								<img src="images/roles/jungle.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/roles/bot.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/roles/support.png" class="rounded-circle">
							</li>
							<li>
								<img src="images/roles/mid.png" class="rounded-circle">
							</li>
						</ul>
					</div>
				...
				<div class="current-order">
					<div class="ranks row offset-lg-2">
						<div class="starting-rank col-lg-3 col-sm-4 col-xs-4">
							<img src="images/Divisions/5_1.png"/>
							<p class="text-center">
								<h5>Starting Rank</h5>
								<em>Bronze I</em>
							</p>
						...
						<div class="current-rank col-lg-3 col-sm-4">
							<img src="images/Divisions/4_3.png"/>
							<p class="text-center">
								<h5>Current Rank</h5>
								<em>Silver I</em>
							</p>
						...
						<div class="desired-rank col-lg-3 col-sm-4">
							<img src="images/Divisions/3_1.png"/>
							<p class="text-center">
								<h5>Desired Rank</h5>
								<em>Gold I</em>
							</p>
					...
					<div class="col-sm-12 d-flex justify-content-center">
						<ul class="current-order-helper">
							...
							<li class="disactive">
								<img src="images/Divisions/3_3.png">
								<span>G1</span>
							</li>
							<li class="disactive">
								<img src="images/Divisions/3_3.png">
			...
			<div class="col-sm-12 mt-5">
				<div class="row pt-5 pb-5">
					...
					<div class="col-md-3 d-flex flex-column mt-auto">
						<button class="btn btn-success">Gift Booster</button>
						<button class="btn mt-3">Offline Mode</button>
						<button class="btn btn-danger mt-3">Pause Order</button>
						<button class="btn btn-primary mt-3" disabled>Unpause Order</button>
						<button class="btn btn-primary mt-3">Review Booster</button>
					</div>
				</div>
			</div>
			<div class="col-sm-12 mt-5">
	                    ...
	                    <div class="container">
	                        <div class="row">
	                            <div class="col-md-6 col-sm-6 col-xs-6 text-center">
	                                <div class="row">
	                                    <div class="col-md-6 col-sm-6 col-xs-6 text-center">
	                                        <img alt="" src="images/HomePage/logoo.png" width="100px">
	                                        <span class="text-bj">BOOST&nbspEXPRESS</span>	
	                                    </div>
	                                    <div class="col-md-6 col-sm-6 col-xs-6 text-center" style="top:20px">
	                                            <a href="#"><img src="images/MemberArea/facebook.png" style="width:30px;height:30px"></a>
	                                           	<a href="#"><img src="images/MemberArea/google.png" style="width:30px;height:30px"></a>
	                                            <a href="#"><img src="images/MemberArea/twitter.png" style="width:30px;height:30px"></a>
	                                            <a href="#"><img src="images/MemberArea/youtube.png" style="width:30px;height:30px"></a>
	                                        </ul>
	                                    </div>
	                                </div>
	...
	<script src="js/backend/jquery-3.2.1.slim.min.js"></script>
	<script src="js/backend/jquery.popper.min.js"></script>
	<script src="js/eloboosting/bootstrap.min.js"></script>
	<script>
		function openNav() {
